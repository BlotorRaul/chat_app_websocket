...
public class ClientGUI extends JFrame implements MessageListener{
    ...
    private JScrollPane messagePanelSrollPane;
    ...
    private void addChatComponents(){
        ...
        messagePanelSrollPane = new JScrollPane(messagePanel);
        messagePanelSrollPane.setBackground(Utilities.TRANSPARENT_COLOR);
        messagePanelSrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        messagePanelSrollPane.getVerticalScrollBar().setUnitIncrement(16);
        messagePanelSrollPane.getViewport().addChangeListener(new ChangeListener() {
            @Override
        ...
        chatPanel.add(messagePanelSrollPane, BorderLayout.CENTER);
    ...
    public void onMessageReceive(Message message) {
        ...
        messagePanelSrollPane.getVerticalScrollBar().setValue(Integer.MAX_VALUE);
